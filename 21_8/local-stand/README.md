...
changed: [localhost] => 
    changed: true
    path: /disk/VMs/k8s_rootfs/etc/cloud/cloud-init.disabled
    state: absent
...
changed: [localhost] => (item=clickhouse) => 
    ...
    opts: lowerdir=/disk/VMs/k8s_rootfs,upperdir=/disk/VMs/overlays/clickhouse/upper,workdir=/disk/VMs/overlays/clickhouse/work,noauto
    passno: '0'
    src: overlay
changed: [localhost] => (item=vector) => 
    ...
    opts: lowerdir=/disk/VMs/k8s_rootfs,upperdir=/disk/VMs/overlays/vector/upper,workdir=/disk/VMs/overlays/vector/work,noauto
    passno: '0'
    src: overlay
changed: [localhost] => (item=lighthouse) => 
    ...
    opts: lowerdir=/disk/VMs/k8s_rootfs,upperdir=/disk/VMs/overlays/lighthouse/upper,workdir=/disk/VMs/overlays/lighthouse/work,noauto
    passno: '0'
    src: overlay
