# Для домашнего задания 21.7 `Компоненты Kubernetes`

## commit_82, master Предварительная подготовка
...
git commit -am 'commit_82, master' \
&& git push \
--set-upstream \
study_fops39 \
master \
...
git commit -am 'commit1, 21_7-comp-k8s' \
&& git push \
--set-upstream \
study_fops39 \
21_7-comp-k8s \
